 ...
 * @author tefad
 */
public class Impacto  extends Ejercito {
    ImageIcon Apariencia1=new ImageIcon(getClass().getResource("/Img/impacto.jpg"));
    ImageIcon Apariencia2=new ImageIcon(getClass().getResource("/Img/impactoatacando.jpg"));
    ...
    String nombreE;
    public Impacto(int x, int y, ModeloEjercito ejercito){
        super(x, y, ejercito);
        this.posx=x/35;
        this.posy=y/35;
