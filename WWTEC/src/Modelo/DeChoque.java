...
public class DeChoque  extends Ejercito {
    ImageIcon Apariencia1=new ImageIcon(getClass().getResource("/Img/dechoque.jpg"));
    ImageIcon Apariencia2=new ImageIcon(getClass().getResource("/Img/dechoqueatacando.jpg"));
    ...
    public DeChoque(int x, int y, ModeloEjercito ejercito){
        super(x, y, ejercito);
        this.posx=x/35;
        this.posy=y/35;
